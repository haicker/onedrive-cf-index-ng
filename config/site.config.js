...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'haicker@haoka.eu',
  ...
  footer:
    'Powered by onedrive-cf-index-ng. Made by cscecgeo.',
